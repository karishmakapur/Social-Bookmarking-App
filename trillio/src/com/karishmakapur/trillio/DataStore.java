...
public class DataStore {
	...
	private static void loadWebLinks() {
		...
		bookmarks[0][2] = BookmarkManager.getInstance().createWebLink(2002, "Interface vs Abstract Class",
				"http://mindprod.com/jgloss/interfacevsabstract.html", "http://www.mindprod.com");
	...
	private static void loadMovies() {
		...
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004, "Ikiru", "", 1952, new String[] { "Takashi" },
				new String[] { "Shimura", "Minoru Chiaki", "Akira Kurosawa" }, MovieGenre.FOREIGN_MOVIES, 8.4);
	}
